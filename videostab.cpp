...
VideoStab::VideoStab(int device)
{
    capture.open("/home/shashwat/Videos/test.mp4");

    writer.open("output1.avi",CV_FOURCC('X','V','I','D'),25,Size(1920,1080));
